...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
          <a class="navbar-brand" href="./">Historique des volets</a>
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="./capteurs.php">Capteurs</a></li>
                    <li><a class="dropdown-item" href="./moteur.php">Moteurs</a></li>
              ...
              <li class="nav-item">
                <a class="nav-link active" href="#" tabindex="-1" aria-current="page"">Quizz</a>
              </li>
            </ul>
